...
//Enque elements check 2 conditions, full,empty.
//while enquing a element we use (rear+1)%N;
void enque(int data) {
...
//deque element from circular linked list, just change front to (front + 1)%N;
void deque(){
